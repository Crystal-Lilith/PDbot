...
class InterpreterInputter(object):
    ...
    def check_is_owner(self,message):
        if message.author.id in [207188318130012160, 300126997718237195, 524288464422830095, 562086061153583122]:
            return True
        else:
            return False
...
class Interpreter(object):
    ...
    async def __call__(self,client,message,content):
        if message.author.id not in [207188318130012160, 300126997718237195, 524288464422830095, 562086061153583122]:
